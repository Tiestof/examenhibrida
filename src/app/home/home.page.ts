...
import { ListaPublicacionesComponent } 
         from '../Componentes/lista-publicaciones/lista-publicaciones.component';
import { RouterModule } from '@angular/router';
import { IonFabButton, IonIcon, IonHeader, IonToolbar, 
...
@Component({
  ...
  standalone: true,
  imports: [RouterModule, IonFabButton, IonIcon, IonHeader, 
            IonToolbar, IonTitle, IonContent, ListaPublicacionesComponent],
})
